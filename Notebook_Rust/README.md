...
- [Structs.ipynb](./Structs.ipynb): **Structs (Estructuras):** Crear estructuras de datos personalizadas, acceso a campos, métodos con `impl`, funciones asociadas como `new()`, y retorno de `Result` desde métodos.
