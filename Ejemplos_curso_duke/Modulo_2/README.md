...
- [Overview of project files](./1-components/README.md)
- [Variable assignment and immutability](./2-variables/)
- [Basics of control flow](./3-control-flow/)
- [Shadowing variables](./4-shadowing/)

### Lesson 2: Loops and Control Flow
- [Introduction to loops in Rust](./5-loops/)
- [Conditional statements](./6-conditionals/)
- [The while loop](./7-while-loops/)
- [The for loop](./8-for-loops/)
- [Break and continue](./9-break-continue/)
- [The match expression](./10-match-control-flow/)

### Lesson 3: Function Basics
- [Introduction to functions](./11-unit-functions/)
- [Return values](./12-return-values/)
- [Function arguments](./13-function-arguments/)
- [The borrowing concept](./14-borrowing/)
- [Using Panic!](./15-panic/)
- [Error handling with match](./16-error-handling/)
